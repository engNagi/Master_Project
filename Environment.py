...
class Environment(object):
    ...
    @classmethod
    def reset(cls, controller, grid_size=0.25, scene="FloorPlan220", depth_image=False, class_image=False, object_image=False,
        ...
        #event = controller.step(dict(action="TeleportFull", x=-4.25, y=0.909619451, z=2.75, rotation=90, horizon=0.0))
        ...
        goal = [-0.5, 0.909619451, 1.9]
        return agent_position, done, goal, object_position
    ...
    def take_action(cls, action, controller, object_name="LightSwitch"):
        ...
        return agent_position, done, reward, obj_agent_dis, visible
